 ...
 */
@AutoConfiguration
public class RagConfiguration { // TODO 抽象向量库接口，满足pg、es、milvus、redis-stack等   rag能力为可关闭的，否则强依赖向量库配置

    @Bean
    @ConditionalOnBean(VectorStore.class)
    public EmbeddingHandler embeddingHandler(VectorStore vectorStore) {
        return new EmbeddingHandler(vectorStore);
    }
