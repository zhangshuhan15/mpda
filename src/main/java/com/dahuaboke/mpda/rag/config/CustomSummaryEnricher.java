 ...
 */
public class CustomSummaryEnricher implements DocumentTransformer {
    ...
    public CustomSummaryEnricher(ChatModel chatModel, List<SummaryType> summaryTypes) {
        this(chatModel, summaryTypes, "以下是该部分的内容: 总结该部分的关键主题和实体.\n\n摘要:", MetadataMode.ALL);
    }

    public CustomSummaryEnricher(ChatModel chatModel, List<SummaryType> summaryTypes, String summaryTemplate, MetadataMode metadataMode) {
