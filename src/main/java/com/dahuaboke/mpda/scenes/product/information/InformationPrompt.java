package com.dahuaboke.mpda.scenes.product.information;


import com.dahuaboke.mpda.scenes.product.AbstractProductPrompt;
 ...
 */
@Component
public class InformationPrompt extends AbstractProductPrompt {

    public InformationPrompt() {
