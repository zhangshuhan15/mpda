...
import com.dahuaboke.mpda.agent.scene.SceneWrapper;
import com.dahuaboke.mpda.scenes.resolution.ResolutionPrompt;
...
public class SceneManager implements BeanPostProcessor {
    ...
    public Flux<String> apply(String conversationId, String query) throws MpdaException {
        if (preSceneWrapper == null) {
            ResolutionPrompt prompt = (ResolutionPrompt) preScene.prompt();
